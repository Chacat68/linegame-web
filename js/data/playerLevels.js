...
export const PLAYER_LEVELS = [
  ...
  { level: 4,  title: '星际行商',   expRequired: 600,   icon: '⭐', perk: '所有船只货舱 +5' },
  { level: 5,  title: '贸易精英',   expRequired: 1000,  icon: '💫', perk: '买入价格 -3%' },
  { level: 6,  title: '商业专家',   expRequired: 1600,  icon: '🔥', perk: '所有船只燃料效率 +10%' },
  { level: 7,  title: '行会长老',   expRequired: 2400,  icon: '👑', perk: '所有派系好感 +10' },
  { level: 8,  title: '商业寡头',   expRequired: 3500,  icon: '🏆', perk: '所有船只货舱 +10' },
