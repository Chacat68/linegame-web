...
export const SHIP_TYPES = [
  {
    ...
    modSlots: 1,
    skills: [
      { id: 'quick_trade', name: '快速交易', emoji: '⚡', desc: '买卖价格波动减少5%', type: 'passive', effect: { priceStability: 0.05 } },
    ],
    desc: '轻型穿梭机，贸易入门之选',
  },
  {
    ...
    modSlots: 2,
    skills: [
      { id: 'bulk_discount', name: '批量折扣', emoji: '📦', desc: '批量买入时价格降低3%', type: 'passive', effect: { buyDiscount: 0.03 } },
      { id: 'heavy_armor', name: '重型装甲', emoji: '🛡️', desc: '受到伤害减少15%', type: 'passive', effect: { damageReduction: 0.15 } },
    ],
    desc: '大型货舱，长途贸易利器',
  },
  {
    ...
    modSlots: 2,
    skills: [
      { id: 'evasion', name: '紧急闪避', emoji: '💨', desc: '30%概率回避负面随机事件', type: 'passive', effect: { eventEvasion: 0.3 } },
      { id: 'speed_bonus', name: '超速引擎', emoji: '🏎️', desc: '燃料消耗额外减少10%', type: 'passive', effect: { fuelBonus: 0.1 } },
    ],
    desc: '速度极快、省油，但货舱较小',
  },
  {
    ...
    modSlots: 3,
    skills: [
      { id: 'market_dominance', name: '市场支配', emoji: '👑', desc: '卖出价格提高5%', type: 'passive', effect: { sellBonus: 0.05 } },
      { id: 'fleet_command', name: '舰队指挥', emoji: '🎖️', desc: '全舰队派遣收益提高8%', type: 'passive', effect: { fleetBonus: 0.08 } },
    ],
    desc: '帝国级巨型货舰，终极贸易船只',
  },
];
...
export const SHIP_MODS = [
  { id: 'mod_cargo_rack',     name: '扩展货架',     emoji: '📦', cost: 500,   category: 'cargo',  desc: '货舱 +10',           effect: { cargo: 10 } },
  { id: 'mod_cargo_compress', name: '压缩货舱',     emoji: '🗜️', cost: 1500,  category: 'cargo',  desc: '货舱 +20',           effect: { cargo: 20 } },
  { id: 'mod_fuel_cell',      name: '辅助燃料电池', emoji: '🔋', cost: 600,   category: 'engine', desc: '燃料 +30',           effect: { maxFuel: 30 } },
  { id: 'mod_ion_drive',      name: '离子推进器',   emoji: '🔥', cost: 1800,  category: 'engine', desc: '耗油 ×0.9',          effect: { fuelEff: 0.9 } },
  { id: 'mod_shield_gen',     name: '护盾发生器',   emoji: '🛡️', cost: 1000,  category: 'hull',   desc: '船体 +30',           effect: { hull: 30 } },
  { id: 'mod_nano_repair',    name: '纳米修复系统', emoji: '🔧', cost: 2500,  category: 'hull',   desc: '船体 +50，自动修复', effect: { hull: 50, autoRepair: 2 } },
  { id: 'mod_trade_computer', name: '贸易计算机',   emoji: '💻', cost: 2000,  category: 'trade',  desc: '买入折扣 2%',        effect: { buyDiscount: 0.02 } },
  { id: 'mod_broker_ai',      name: '经纪人AI',     emoji: '🤖', cost: 3000,  category: 'trade',  desc: '卖出加价 3%',        effect: { sellBonus: 0.03 } },
];
