// js/data.js — Game constants: star systems, goods, upgrades, initial state

'use strict';

const GOODS = [
  { id: 'food',       name: '食物',   emoji: '🌾', basePrice: 10,  desc: '维持生命的基本食物'   },
  { id: 'water',      name: '水资源', emoji: '💧', basePrice: 15,  desc: '珍贵的液态水'         },
  { id: 'minerals',   name: '矿石',   emoji: '⛏',  basePrice: 30,  desc: '工业生产原材料'       },
  { id: 'technology', name: '科技',   emoji: '🔬', basePrice: 60,  desc: '高端科技产品'         },
...
// Positions use relative [0,1] coordinates so they scale with the canvas.
// prices: per-good multiplier at this system (<1 = cheap, >1 = expensive)
const SYSTEMS = [
  {
    id: 'sol_prime', name: '太阳主星',
    x: 0.15, y: 0.35, color: '#4CAF50', type: 'agricultural', typeLabel: '农业',
    description: '银河系农业中心，粮食丰产之地',
    prices: { food:0.4, water:0.5, minerals:1.2, technology:1.8, luxury:2.0, weapons:1.5, medicine:1.3, fuel:1.1 },
  },
  {
    id: 'nova_station', name: '新北京站',
    x: 0.75, y: 0.20, color: '#2196F3', type: 'technology', typeLabel: '科技',
    description: '银河系最先进的科技研究中心',
    prices: { food:1.8, water:1.5, minerals:1.4, technology:0.4, luxury:1.3, weapons:1.2, medicine:0.6, fuel:1.3 },
  },
  {
  ...
  },
  {
    ...
    prices: { food:1.4, water:1.2, minerals:1.6, technology:1.2, luxury:0.5, weapons:2.0, medicine:1.2, fuel:1.4 },
  },
  {
    id: 'war_front', name: '战争前线',
    x: 0.25, y: 0.78, color: '#E91E63', type: 'military', typeLabel: '军事',
    description: '星际战争的前沿阵地，武器需求旺盛',
    prices: { food:2.0, water:1.8, minerals:1.5, technology:1.4, luxury:2.5, weapons:0.4, medicine:2.5, fuel:1.6 },
  },
  {
    id: 'medical_hub', name: '医疗中枢',
    x: 0.65, y: 0.80, color: '#00BCD4', type: 'medical', typeLabel: '医疗',
    description: '最先进的医疗研究和生产中心',
    prices: { food:1.5, water:1.3, minerals:1.6, technology:0.8, luxury:1.5, weapons:1.8, medicine:0.35, fuel:1.5 },
  },
  {
    id: 'fuel_depot', name: '深空补给站',
    x: 0.40, y: 0.20, color: '#FFC107', type: 'commercial', typeLabel: '补给',
    description: '为长途星际旅行提供补给的中转站',
    prices: { food:1.3, water:1.1, minerals:1.4, technology:1.6, luxury:2.0, weapons:1.8, medicine:1.4, fuel:0.3 },
  },
  {
...
const VICTORY_NET_WORTH  = 50000;
const FUEL_COST_PER_UNIT = 0.8;   // fuel units per map-distance unit
