...
export const STEPS = [
  ...
  // ==================== 阶段 2: 第一轮交易 ====================
  {
    ...
    phase: 2,
    title: '打开市场终端',
    content: '点击底部导航的【市场】进入交易所终端。\n\n先看现货价格和货舱余量：低于常态价的商品适合买入，货舱越空，能建立的仓位越大。',
  ...
  },
  {
    ...
    phase: 2,
    title: '买入低价货',
    content: '在现货交易区选择一个价格偏低的商品，点击【买入】，在确认单里选择数量并提交。\n\n第一次不需要追求满仓，先让货舱里有货，理解这条路线如何运转。',
  ...
  },
  {
    ...
    phase: 2,
    title: '卖出并结算利润',
    content: '抵达后重新打开市场，找到货舱里已有的商品并点击【卖出】。\n\n完成卖出后，资金、货舱和利润会一起更新；这就是后续大部分经营链路的基础节奏。',
    highlight: '#market-spot-pane',
    position: 'left',
    trigger: 'action:sell',
    npcName: '新星球管理员',
