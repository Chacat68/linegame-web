...
export const STEPS = [
  // ==================== 阶段 1: 星际初航 ====================
  {
    ...
    phase: 1,
    title: '欢迎来到银河系',
    content: '银河历 3045 年，你继承了一艘老旧货船——"星际信使 I 号"。\n你的目标：通过星际贸易积累财富，建立属于自己的商业帝国！',
    highlight: null,
    position: 'center',
    trigger: 'manual',
    npcName: '港口管理员 汤姆',
  ...
  // ==================== 阶段 2: 第一桶金 ====================
  {
    ...
    phase: 2,
    title: '打开市场',
    content: '现在来学习赚钱！点击右侧的 【🏪 市场】 标签，查看当前星球的商品。\n你现在在 太阳主星（农业星球），食物和水资源很便宜。',
    highlight: '[data-tab="tab-market"]',
    position: 'left',
    trigger: 'click:tab-market',
    npcName: '港口管理员 汤姆',
    npcIcon: '👨‍✈️',
    reward: null,
    canSkip: false,
  },
  {
    ...
    phase: 2,
    title: '买入商品',
    content: '看到了吗？食物在农业星球非常便宜（价格系数低）。\n点击食物那一行的 【买入】 按钮，尽量多买一些！\n记住贸易的黄金法则：低买高卖！',
  ...
  },
  {
    ...
    phase: 2,
    title: '出发去卖货！',
    content: '太好了！货舱里装满了便宜的货物。\n现在在星图上点击另一个星球（比如 新北京站 或 战争前线），到那里高价卖出！\n提示：工业/科技星球 食物贵，军事星球 武器便宜。',
  ...
  },
  {
    ...
    phase: 2,
    title: '卖出商品',
    content: '你到达了新的星球！打开市场，找到你货舱里的商品，点击 【卖出】 赚取利润！\n注意观察价格差异——这就是你的利润来源。',
    highlight: '#market-tbody',
    position: 'left',
    trigger: 'action:sell',
    npcName: '新星球管理员',
