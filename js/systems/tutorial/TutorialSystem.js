...
export const STEPS = [
  ...
  },
  {
    ...
    phase: 1,
    title: '了解你的状态',
    content: '顶部状态栏显示你的 【信用积分】、【当前位置】、【当前飞船】 和 【银河历天数】。\n你现在有 1,000 信用积分，足够开始第一笔交易了。',
  ...
  },
  {
    ...
    phase: 1,
    title: '你的飞船',
    content: '底部状态条显示飞船的 【燃料】、【船体】 和 【货舱】 状态。\n货舱用来装货物，燃料在星际旅行时消耗，船体就是飞船耐久。',
  ...
  // ==================== 阶段 2: 第一桶金 ====================
  {
    ...
    phase: 2,
    title: '认识市场',
    content: '现在来学习赚钱！点击底部导航里的 【市场】 打开交易所终端，打开后再继续。\n你现在在太阳主星，留意低价商品和货舱余量，这就是买入的好时机。',
  ...
  },
  {
    ...
    phase: 2,
    title: '买入商品',
    content: '在市场的现货交易区选择低价商品，点击 【买入】 按钮，在弹窗中调整数量，然后确认购买。\n尽量多买一些！记住贸易的黄金法则：低买高卖！',
  ...
  },
  {
    ...
    phase: 2,
    title: '出发去卖货！',
    content: '太好了！货舱里装上了便宜货。\n现在回到星图，点击另一个需求更高的星球，到那里高价卖出。\n\n提示：星球详情会告诉你能否出航、燃料是否足够。',
  ...
  },
  {
    ...
    phase: 2,
    title: '卖出商品',
    content: '你到达了新的星球！重新打开市场，点击货舱里商品的 【卖出】 按钮，赚取利润。\n注意观察价格差异，这就是你的利润来源。',
    highlight: '#market-spot-pane',
    position: 'left',
    trigger: 'action:sell',
    npcName: '新星球管理员',
  ...
  },
  {
    ...
    phase: 3,
    title: '把教程接到任务',
    content: '底部 【档案】 会打开任务档案。这里会告诉你目标、奖励和建议航线，也能查看科技、派系和成就。\n\n先看一眼任务简报，接下来我们把刚学会的贸易动作，正式接到第一张委托上。',
    highlight: '.bottom-nav-btn[data-view="quests"]',
    position: 'top',
    trigger: 'manual',
    npcName: '港口管理员 汤姆',
    npcIcon: '👨‍✈️',
  ...
  },
  {
    ...
    phase: 3,
    title: '教程完成！',
    content: '你已经掌握了星际贸易的基础，也亲手完成了第一张正式委托！\n\n接下来底部的当前行动条会继续给你下一步建议：\n  · 在生产星球低价买入，到需求星球高价卖出\n  · 关注任务目标，把贸易和航行顺手做成章节进度\n  · 提升公司等级，逐步开放资本、贸易站和商网运营\n\n公司名称可以随时在机库的公司面板里修改。目标：积累 50,000 信用积分，重振商业帝国！',
    highlight: null,
    position: 'center',
    trigger: 'manual',
    npcName: '港口管理员 汤姆',
