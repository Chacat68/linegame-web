...
- 测试基线：96 个测试文件、930 项测试，覆盖经济/贸易提交顺序/经营金融/舰队/科研任务档案动作/存档/探索/引导/会话生命周期/时钟/UI 所有权等核心系统
...
- ✅ 建立最小回归集：930 项测试覆盖存档、经济、贸易提交顺序、派遣与舰队动作、经营金融/商网联动、科研任务档案动作、会话生命周期与 UI 壳层契约
