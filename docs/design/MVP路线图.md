...
- 测试基线：103 个测试文件、970 项测试，覆盖经济/贸易、航行、探索、事件、自动派遣与日结算提交顺序/经营金融/舰队/科研任务档案动作/剧情运行时/存档/引导/会话生命周期/时钟/日志上下文/UI 所有权等核心系统
...
- ✅ 建立最小回归集：970 项测试覆盖存档、经济、贸易、航行、探索、事件、自动派遣与日结算提交顺序、舰队动作、经营金融/商网联动、科研任务档案动作、剧情运行时、会话生命周期、日志消息上下文与 UI 壳层契约
